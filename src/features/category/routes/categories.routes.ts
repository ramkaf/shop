...
categoriesRouter.get('/', validateQuerySchema(getAllCategoriesSchema),categoriesController.getAll);
...
categoriesRouter.delete('/:dkp', validateParamSchema(getOneCategorySchema),categoriesController.delete);
