...
productsRouter.post('/' ,isAdmin , uploadImage.single("mainImage"), validateBodySchema(createProductSchema), productsController.create)
productsRouter.put('/', isAdmin , uploadImage.single("mainImage") ,validateBodySchema(updateProductSchema), productsController.update) 
